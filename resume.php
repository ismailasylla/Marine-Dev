  ...
  <div class="container">
    <div class="row info" style="text-align:center;">
      <div class="col-xs-12 alert alert-info">
        Thanks for checking out my resume Click home to goback to the home-page <a class="alert-link" href="index.php">HOME</a>
    ...
    <div class="resume">
      <header class="page-header">
        <h1 class="page-title">Resume of Ismaila Sylla</h1>
        <small> <i class="fa fa-clock-o"></i> Last Updated on: <time>Saturday, October 27, 2018</time></small>
      </header>
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
          <div class="panel panel-default">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="col-xs-12 col-sm-4">
                    <figure>
                      <img class="img-circle img-responsive" alt="" src="img/me.jpg">
                    </figure>
            ...
            <div class="bs-callout bs-callout-danger">
              <h4>Summary</h4>
              <p>
              I'm a software developer, focused on web development, Network security and
              Application industry. I’m Seeking an opportunity to highlight my knowledge and technical
              skills acquired during my academic and professional training, I intend to continue learnin
              even more in the field of software development.
              </p>
              <p>
                <!-- something here -->
              </p>
              ...
              <ul class="list-group">
                <!-- <a class="list-group-item inactive-link" href="#"> -->
                  <!-- <h4 class="list-group-item-heading">
                    Software Engineer at Marines.Tech.dev
                  </h4>
                  <p class="list-group-item-text">
                    Lorem ipsum dolor sit amet, ea vel prima adhuc, scripta liberavisse ea quo, te vel vidit mollis
                    complectitur. Quis verear mel ne. Munere vituperata vis cu,
                    te pri duis timeam scaevola, nam postea diceret ne. Cum ex quod aliquip mediocritatem, mei habemus
                    persecuti mediocritatem ei.
                  </p>
                </a> -->
                <a class="list-group-item inactive-link" href="#">
                  <h4 class="list-group-item-heading">Software Engineer at Marines.Tech.dev</h4>
                  <p class="list-group-item-text">
                    Lorem ipsum dolor sit amet, ea vel prima adhuc, scripta liberavisse ea quo, te vel vidit mollis
                    complectitur.
            ...
            <div class="bs-callout bs-callout-danger">
              <h4>Key Expertise</h4>
              <ul class="list-group">
                <li class="list-group-item"> Nodejs on the back-end  <img src="img/stacks/nodejs.png" class="client-logo key-expertise "></li>
                <li class="list-group-item"> Angular on the front-end <img src="img/stacks/angularjs.png" class="client-logo key-expertise "></li>
                <li class="list-group-item"> React on the front-end  <img src="img/stacks/react-js-logo.png" class="client-logo key-expertise "></li>
                <li class="list-group-item"> Vuejs on the front-end  <img src="img/stacks/vuejs.png" class="client-logo key-expertise "></li>
                <li class="list-group-item">Laravel php on the back-end  <img src="img/stacks/laravel_logo.png" class="client-logo key-expertise "></li>
                <li class="list-group-item"> Wordpress CMS  <img src="img/stacks/wordpress-logo.png" class="client-logo key-expertise "></li>
            ...
            <div class="bs-callout bs-callout-danger">
              ...
              <ul class="list-group">
                <a class="list-group-item inactive-link" href="#">
                  ...
                  <div class="progress">
                    <div data-placement="top" style="width: 80%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                  ...
                  <div class="progress">
                    <div data-placement="top" style="width: 65%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="1"
                  ...
                  <div class="progress">
                    <div data-placement="top" style="width: 10%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
